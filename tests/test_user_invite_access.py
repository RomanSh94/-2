...
# NOTE: the three discuss-menu/topic integration tests for a registered
# ordinary user (open discuss menu, use a discuss topic, cannot touch another
# user's session) live in tests/test_questionnaire_discuss.py instead of here
# -- that module already owns the FakeUser/FakeMessage/FakeCallback/
# _complete_flow/registry-fixture setup this scenario needs, and importing it
# from this file to reuse those private helpers would create unnecessary
# coupling between two test modules. See that file's
# "registered ordinary user" section.
